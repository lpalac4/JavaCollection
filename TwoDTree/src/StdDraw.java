...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
	...
	StdDraw.circle(0.95, 0.5,0.005);
	StdDraw.show(1000);
	StdDraw.circle(0.98, 0.5,0.005);
	StdDraw.show(1000);
	StdDraw.circle(1.02, 0.5,0.005);
	StdDraw.show(1000);
	StdDraw.circle(1.06, 0.5,0.005);
	StdDraw.show(1000);
	...
	while(true) {
		if(StdDraw.mousePressed()) {
			...
			System.out.println("click: (" + xx + ", " + yy + ")");
			StdDraw.circle(xx,yy,0.005);
		}
		StdDraw.show(100);
	}
    }*/
